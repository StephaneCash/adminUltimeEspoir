...
import { newCategorie, updateCategorie } from "../../features/CategoriesMagazine";
import { useDispatch, useSelector } from 'react-redux';
import Loader from '../../components/loader/Loader';

const AddCategorieMagazine = () => {

    const [nom, setNom] = useState('');
    const [description, setDescription] = useState('');

    const dispatch = useDispatch();
    const isLoading = useSelector(state => state.categoriesMagazines);
    ...
    const updCategorie = (e) => {
        ...
        formData.nom = nom;
        formData.description = description
        formData.idCategorie = state && state.data && state.data.id;
...
export default AddCategorieMagazine