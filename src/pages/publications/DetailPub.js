                            ...
                            <table className='table table-striped mt-3'>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Image</td>
                                        <td>
                                            <img src={data && baseUrlImage + "/" + data.url} style={{ width: "100px", height: "100px", borderRadius: "120px" }} alt="" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {
                                                data && data.urlDOc ?
                                                    <a className='btn btn-primary' href={data && baseUrlImage + "/" + data.urlPDF} download>
                                                        Télécharger
